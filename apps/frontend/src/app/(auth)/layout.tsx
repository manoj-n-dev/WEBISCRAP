...
export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-dvh flex items-center justify-center py-[88px] bg-bg-0 text-text-hi font-body overflow-hidden">
      ...
      {/* Top Navbar for Logo & Return navigation */}
      <nav className="absolute top-0 left-0 right-0 p-[16px] sm:p-[24px] z-50 flex items-center justify-between">
        <Link href="/" aria-label="WEBISCRAP home">
          <Logo variant="lockup" size={24} />
        </Link>
        <BackButton fallbackHref="/" label="Return home" />
      </nav>
